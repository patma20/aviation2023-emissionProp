...
\hypersetup{
	...
	pdfsubject={}, % insert keywords here
}

\graphicspath{{../figures/}}

\title{Multi-point Aeropropulsive Design Optimization of a High-Bypass Turbofan Engine} % change
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{JetA-H2_bar_chart_diff.png.pdf}
