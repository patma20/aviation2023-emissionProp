...
% [ ] TODO: AL-PA, Consider changing the title to "Comparing Hydrogen and Jet-A for an N+3 Turbofan with Water Recirculation using Gradient-Based Optimization"
\title{Comparing Hydrogen and Jet-A for an Ultra High Bypass Ratio Turbofan with Water Recirculation} % change
...
%	OVERALL COMMENTS
% ==================================================
% 1. AL-PA, Fix the citation for Kalnay1996
...
% TODO: AL - PA, What is the citation key "Kalnay1996"?  It's not in the MDOLab Bib or references.bib
\begin{table}[hbt!]
    \centering
    \caption{
