...
%   - For example, the SLS point is important for making sure the turbomachinery and flow paths are designed to meet a static thrust target
...
% NOTE: AL-PA, The design point sizes the flow paths and scales the turbomachinery.  The off-design has the exact same flow path as the design mode cycle.  The turbo machinery maps are scaled using scalar quantities for off-design performance.
...
% [ ] TODO: AL-PA, consider removing this stuff and just direct the reader to the pyCycle paper.
