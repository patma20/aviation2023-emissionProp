...
It was also observed that $X_{\rm{H_2O,CRZ}}$ is increased until the model breaks due to the CEA solver not being able resolve the increased \ce{H2O} molecules.
...
This is most likely due to the properties of \ce{H2} compared to Jet-A.
...
Table~\ref{tab:thrust} shows that the fraction of gross thrust generated by the core nozzle is decrease when we use \ce{H2} and add water recovery.
...
% heavier engine due to condenser, but less fuel needed
