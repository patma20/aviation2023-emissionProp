...
% [ ] TODO: AL-PA, Add a small table to show the mach and altitude of each flight condition
...
% [ ] TODO: AL-PA, I would remove this figure.  Not adding anything more than the detailed XDSM you provide later.
\begin{figure}[hbt!]
    \centering
...
% [ ] TODO: AL-PA, I'm not sure this subsection is necessary.  We will describe the performance metrics in the optimization problem section.  Consider moving it there.
...
% [ ] TODO: AL-PA, Why are some of the fist words in the descriptions capitalized but not others?  I think this should be consistent.
% [ ] TODO: AL-PA, Change the lower heating value references to footnotes. i.e \footnote{\url{...}}
\begin{table}[hbt!]
    \centering
    \caption{
...
% [ ] TODO: AL-PA, This is a good place to discuss the performance metrics and add the equations for TSEC and explain why it's better for this study than TSFC.
